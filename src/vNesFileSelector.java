...
class FileSelector
    ...
    private final vNes midlet;
    
    private final static Image ROOT_IMAGE = vNes.makeImage("/root.png");
    private final static Image FOLDER_IMAGE = vNes.makeImage("/folder.png");
    private final static Image FILE_IMAGE = vNes.makeImage("/file.png");
